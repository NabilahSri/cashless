     ...
     <div class="flex grow flex-col items-center justify-between xl:flex-row xl:px-6">
         <div
             ...
             <a href="{{ route('dashboard') }}" class="xl:hidden">
                 <img class="dark:hidden" src="{{ asset('src/images/logo/logo.png') }}" width="240" alt="Logo" />
                 <img class="hidden dark:block" src="{{ asset('src/images/logo/auth-logo.png') }}" width="240"
                     alt="Logo" />
             </a>
