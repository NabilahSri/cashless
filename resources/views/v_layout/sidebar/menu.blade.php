...
<nav>
    ...
    <div>
        ...
        <ul class="mb-6 flex flex-col gap-1">
            ...
            @if (auth()->user()->role == 'pengelola' && $partner->is_admin == true)
                <!-- Menu Item Dompet -->
                <li>
                    <a href="{{ route('pengelola.index') }}"
                        @click="selected = (selected === 'Pengelola' ? '':'Pengelola')" class="menu-item group"
                        :class="(selected === 'Pengelola') && (page === 'pengelola') ? 'menu-item-active' : 'menu-item-inactive'">
            ...
            <li>
                <a href="{{ route('transaction.index') }}"
                    @click="selected = (selected === 'Transaksi' ? '':'Transaksi')" class="menu-item group"
                    :class="(selected === 'Transaksi') && (page === 'transaksi') ? 'menu-item-active' :
                    'menu-item-inactive'">
