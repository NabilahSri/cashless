        ...
        <ul class="mb-6 flex flex-col gap-1">
            ...
            <li>
                <a href="#" @click.prevent="selected = (selected === 'Pengguna' ? '':'Pengguna')"
                    class="menu-item group"
                    :class="(selected === 'Pengguna') || (page === 'member' || page === 'partner') ? 'menu-item-active' :
                    'menu-item-inactive'">
                    <svg :class="(selected === 'Pengguna') || (page === 'member' || page === 'partner') ?
                ...
                <div class="translate transform overflow-hidden"
                    ...
                    <ul :class="sidebarToggle ? 'xl:hidden' : 'flex'"
                        ...
                        <li>
                            <a href="{{ route('partner.index') }}" class="menu-dropdown-item group"
                                :class="page === 'partner' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                                Partner
                            </a>
                        </li>
                    </ul>
