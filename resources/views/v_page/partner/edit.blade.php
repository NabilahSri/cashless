                ...
                <form action="{{ route('partner.update', $partner) }}" method="POST">
                    <div class="-mx-2.5 flex flex-wrap gap-y-5">
                        ...
                        <div class="w-full px-2.5 xl:w-1/2">
                            ...
                            <input type="text" placeholder="Masukkan nama" name="name" value="{{ $partner->name }}"
                        ...
                        <div class="w-full px-2.5 xl:w-1/2">
                            ...
                            <input type="email" placeholder="Masukkan email" name="email" value="{{ $partner->email }}"
                                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                required />
                        </div>
                        ...
                        <div class="w-full px-2.5 sm:w-1/2">
                            ...
                            <input type="number" placeholder="Masukkan no. telp" name="phone"
                                value="{{ $partner->phone }}"
                                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                required />
                        </div>
                        ...
                        <div class="w-full px-2.5 sm:w-1/2">
                            ...
                            <input type="number" placeholder="Masukkan komisi" name="komisi"
                                value="{{ $partner->komisi }}"
                                class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                required />
                        </div>
                            ...
                            <select multiple=""
                                ...
                                @foreach ($pengelola as $item)
                                    <option value="{{ $item->id }}"
                                        {{ $user_id->contains($item->id) ? 'selected' : '' }}>
                                        {{ $item->name }}</option>
                                @endforeach
                            </select>
                            <!-- End Select -->
