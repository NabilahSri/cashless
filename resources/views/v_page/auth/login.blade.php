...
<head>
    ...
    <!-- <script data-cfasync="false" nonce="b4467bcf-204b-4abb-a418-5604efd66a97">
        try {
            (function(w, d) {
                !(function(j, k, l, m) {
                    if (j.zaraz) console.error("zaraz is loaded twice");
                        ...
                        j.zaraz._v = "5874";
                        j.zaraz._n = "b4467bcf-204b-4abb-a418-5604efd66a97";
                        j.zaraz.q = [];
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        ...
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Sistem Manajemen Transaksi Cashless <br> Mengelola, Memantau, dan Menganalisis Semua
                            Transaksi Non-Tunai Anda
...
<!-- Mirrored from demo.tailadmin.com/signin by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 07 Nov 2025 06:23:32 GMT -->
